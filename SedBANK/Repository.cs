using ConsoleTables;
using SedBANK.Entities;
using SedBANK.Enums;
using SedBANK.Interfaces;
using SedBANK.UI;
using System;
...
namespace SedBANK
{
    public class Repository : IUserLogin, IUserAccountActions, ITransaction
    {
        ...
        public void InitializeData()
        {
            ...
            {
                new UserAccount{Id=1, FullName = "Selim Demirer", AccountNumber=123456,CardNumber =321321, CardPin=123123,AccountBalance=50000.00m,IsLocked=false},
                new UserAccount{Id=2, FullName = "Elif Demirer", AccountNumber=456789,CardNumber =654654, CardPin=456456,AccountBalance=4000.00m,IsLocked=false},
                new UserAccount{Id=3, FullName = "Afro Demirer", AccountNumber=123555,CardNumber =987987, CardPin=789789,AccountBalance=2000.00m,IsLocked=true},
            };
